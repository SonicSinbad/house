package com.fh.service.house.mhouse.impl;
 ...
 * @version
 */
@Service("mhouseService")
public class MhouseService implements MhouseManager{
	...
	public List<PageData> list(Page page)throws Exception{
		return (List<PageData>)dao.findForList("MhouseMapper.datalistPage", page);
	}
	...
	public List<PageData> listAll(PageData pd)throws Exception{
		return (List<PageData>)dao.findForList("MhouseMapper.listAll", pd);
	}
