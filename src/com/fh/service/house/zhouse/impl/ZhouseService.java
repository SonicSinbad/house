package com.fh.service.house.zhouse.impl;
 ...
 * @version
 */
@Service("zhouseService")
public class ZhouseService implements ZhouseManager{
	...
	public void delete(PageData pd)throws Exception{
		dao.delete("ZhouseMapper.delete", pd);
	}
	...
	public void edit(PageData pd)throws Exception{
		dao.update("ZhouseMapper.edit", pd);
	}
	...
	public List<PageData> list(Page page)throws Exception{
		return (List<PageData>)dao.findForList("ZhouseMapper.datalistPage", page);
	}
	...
	public List<PageData> listAll(PageData pd)throws Exception{
		return (List<PageData>)dao.findForList("ZhouseMapper.listAll", pd);
	}
