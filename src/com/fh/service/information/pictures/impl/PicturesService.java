...
public class PicturesService implements PicturesManager {
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<PageData> pathList(PageData pd)throws Exception{
		return (List<PageData>)dao.findForList("PicturesMapper.getAllByHouseId", pd);
	}
	/**新增
	 * @param pd
	 * @throws Exception
	 ...
	 */
	@Override
	public void delTpZF(PageData pd)throws Exception{
		dao.delete("PicturesMapper.delTpZF", pd);
	}
}
