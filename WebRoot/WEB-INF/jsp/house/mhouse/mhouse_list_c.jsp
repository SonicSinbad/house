...
<body class="no-skin">
			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<!-- 检索  -->
						<form action="mhouse/list_c.do" method="post" name="Form" id="Form">
						...
						<table id="simple-table" class="table table-striped table-bordered table-hover" style="margin-top:5px;">	
							<thead>
								<tr>
									...
									<th class="center">总层数</th>
									<th class="center">所在层数</th>
									<th class="center">层数性质</th>
									<th class="center">建筑面积</th>
									<th class="center">朝向</th>
									<th class="center">房源户式</th>
									<th class="center">装修程度</th>
									<th class="center">产权类别</th>
									<th class="center">房屋总价</th>
	...
	<script type="text/javascript">
		...
		function view(Id){
			 ...
			 diag.Drag=true;
			 diag.Title ="预览";
			 diag.URL = '<%=basePath%>mhouse/goView_c.do?MHOUSE_ID='+Id;
			 diag.Width = 850;
			 diag.Height = 655;
			 diag.CancelEvent = function(){ //关闭事件
				 if(diag.innerFrame.contentWindow.document.getElementById('zhongxin').style.display == 'none'){
